                                                         ...
                                                         double constant_speed_power_consumption) const
{
    ...
    for (int i = 0; i < waypoints.size() - 1; i++)
    {
        ...
        auto average_wind_between_waypoints = (waypoints[i].associated_wind->wind_speed + waypoints[i + 1].
            associated_wind->wind_speed) / 2;
        ...
        Eigen::Vector2d perpendicular_wind_vector = average_wind_between_waypoints - (parallel_wind_component *
            direction);
